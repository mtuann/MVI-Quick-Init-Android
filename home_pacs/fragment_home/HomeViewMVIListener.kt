...
class HomeViewMVIListener(val listener: ProgressDownloadListener) {
    ...
    private fun renderViewEffect(homePacsFragment: HomeViewFragment, viewEffect: HomeViewEffect) {

    }

    private fun renderViewState(homePacsFragment: HomeViewFragment, viewState: HomeViewState) {

    }

    fun process(homePacsVM: HomeViewVM, homePacsEvent: HomeViewEvent) {
