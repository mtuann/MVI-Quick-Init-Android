...
class InterpretationViewVM(application: Application) : AacMviViewModel<InterpretationViewState, InterpretationViewEffect, InterpretationViewEvent>(application) {
    companion object {
