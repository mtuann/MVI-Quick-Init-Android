...
class ServerViewFragment: AacMviFragment<ServerViewState, ServerViewEffect, ServerViewEvent, ServerViewVM>() {

    interface OnDataPass {
        fun onDataPass(data: String)
        fun onViewModelPass(viewModel: ServerViewVM)
    }
    ...
    override val viewModel: ServerViewVM by viewModels()
//        get() = TODO("Not yet implemented")


    override fun renderViewState(viewState: ServerViewState) {
//        TODO("Not yet implemented")
    }

    override fun renderViewEffect(viewEffect: ServerViewEffect) {
