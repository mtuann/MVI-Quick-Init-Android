...
import kotlinx.android.synthetic.main.dialog_homePacs.*

class HomePacsDialog(
    val activity: HomePacsActivity,
    val listener: OnSaveHomePacsListener
) : Dialog(activity) {
    companion object {
        val TAG = "HomePacsDialog"
    }

    interface OnSaveHomePacsListener {
        fun onSaveHomePacs()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layout: View = inflater.inflate(R.layout.dialog_homePacs, null)
